...
<body>
	...
	<?php
	$query = mysqli_query($con, "SELECT * FROM disposal");
			$header	= array('item id','item name','device type','item description','item color','device price','date of disposal');
			

			
	echo "<div class='container'>";
		echo "<div class='tb_container'>";
			echo "<h2>Disposal Item Record</h2>";
			...
			echo "</table>";
			echo "<button class='export'><a href='exportdisposal.php' class='excels'><i class=dwn><i>export to excel</a></button>";
		echo "</div>";
	echo "</div>";
