...
<div class="head">
	...
	$query = mysqli_query($con, "SELECT * FROM inventory ORDER BY item_id ASC ");
			$header	= array('item id','item name','device type','item description','item color','device price','Action');
	...
	echo "<div class='container'>";
		echo "<div class='tb_container'>";
			...
			echo "<tbody>";
				...
				echo "<td>"."<a href='edititems.php?id={$list['id']}'><input type='button' class='edititems' value='Edit item'></a>"."</td>";
				echo "</tr>";
